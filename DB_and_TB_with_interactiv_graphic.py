...
for i in range(op):
    ...
    ###
    if i % 100 == 0:
        detailed_balance_mem.append(empirical_loss(visited_DB[-10000:], len(visited_DB[-10000:])))
        trajectory_balance_mem.append(empirical_loss(visited_TB[-10000:], len(visited_TB[-10000:])))
